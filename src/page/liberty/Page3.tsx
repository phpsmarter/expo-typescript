...
const headerData: IHeader = {
  imageUrl: require("../../../assets/liberty/page3_image1.png"),
  likeNumber: 1,
  title: "Toy&Games",
  cateNumber: 853
};
...
const categoryData: ICategoryItem[] = [
  {
    product: {
      ...
      price: 197.99,
      pic: require("../../../assets/liberty/page3_item1.png"),
      color: ["rgba(35, 83, 167, 1.000)", "rgba(203, 28, 7, 1.000)"]
    },
    seller: {
      name: "Sphero",
      logo: require("../../../assets/liberty/page3_item1_logo.png")
    },
    liked: false,
    newProduct: false,
    sell: false
...

  {
    product: {
      ...
      price: 839.5,
      pic: require("../../../assets/liberty/page3_item2.png"),
      color: [
        "rgba(77, 80, 94, 1.000)",
...

  {
    ...
    seller: {
      name: "Traxxas",
      logo: require("../../../assets/liberty/page3_item3_logo.png")
    },
    liked: false,
    sell: false,
    newProduct: false
    ...
    return (
      <View>
        ...
        <ImageBackground
          ...
          source={this.state.headerData.imageUrl}
        >
          <HeaderBar likeNumber={this.state.headerData.likeNumber} />
          <Text
            style={{
              color: "white",
              fontSize: 20,
          ...
          <Text style={{ fontSize: 14, color: "white", textAlign: "center" }}>
            {this.state.headerData.cateNumber} Products
          </Text>
        </ImageBackground>
